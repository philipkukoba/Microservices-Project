...
async function orderverzondenconsumer() {
    ...
    await consumer_order_verzonden.subscribe({ topic: 'order_verzonden', from_beginning: false });
...
async function factuurconsumer() {
    ...
    await consumer_maak_factuur.subscribe({ topic: 'maak_factuur_2', from_beginning: false });
